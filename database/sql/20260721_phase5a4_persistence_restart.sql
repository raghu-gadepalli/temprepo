-- AutoTrades Phase 5A.4: Auction opportunity persistence and restart checkpoints.
-- Target database: backtest.
-- Apply this file before running tests/replay_unprocessed.py or
-- tests/replay_unprocessed_multi.py.
--
-- This layer has no trade ownership. No trade_id or user-trade fields are stored.
...
CREATE TABLE IF NOT EXISTS stock_opportunities (
    ...
    KEY idx_stock_opportunity_signal (signal_id)
